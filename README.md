...
这是一个**纯前端**的**公众号文章 AI 智能排版网站**。

输入 Markdown / 富文本文章，选择排版主题，AI 自动生成符合微信公众号编辑器规范的 HTML，直接粘进公众号编辑器的精致 HTML —— 6 套精选主题 + 自定义主题生成器 + 双关卡校验

网站地址：www.wxtype.top/

整个项目是基于**摸鱼小李和甲木**开发的开源公众号排版skill(**gzh-design-skill**)
